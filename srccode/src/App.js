  ...
  return (
    <div className='box'>
     <div className="containers">
      ...
      <p className='about'>Our Artificial Intelligence powered tools use millions of project data points to ensure that your project is successful</p>
      </div>
      <div className="container1">
        <h2 className='head3'>Supervisor</h2>
        <p className='about2'>Monitors activity to identify project roadblocks.</p>
        <div className="logo">
      ...
      <div className="mid-containers">
        ...
        <h2 className='head3'>Team Builder</h2>
        <p className='about2'>Scans our talent network to craete the optimal team for your project.</p>
        <div className="logo">
        ...
        <h2 className='head3'>Karma</h2>
        <p className='about2'>Regularly evaluates our talent to ensure quality.</p>
        <div className="logo">
      ...
      <h2 className='head3'>calculator</h2>
        <p className='about2'>Uses data from past projects to provide better delivery estimates.</p>
        <div className="logo">
